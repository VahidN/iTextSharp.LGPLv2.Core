...
{
    public class Windows1250EncodingProvider : EncodingProvider
    {
        public override Encoding GetEncoding(int codepage)
        {
            return codepage == 1250 ? new Windows1250() : null;
        }

        public override Encoding GetEncoding(string name)
        {
            return name.Equals("windows-1250", StringComparison.OrdinalIgnoreCase) ? new Windows1250() : null;
        }
    }
