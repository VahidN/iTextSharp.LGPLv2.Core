...
{
    public class Windows1256EncodingProvider : EncodingProvider
    {
        public override Encoding GetEncoding(int codepage)
        {
            return codepage == 1256 ? new Windows1256() : null;
        }

        public override Encoding GetEncoding(string name)
        {
            return name.Equals("windows-1256", StringComparison.OrdinalIgnoreCase) ? new Windows1256() : null;
        }
    }
