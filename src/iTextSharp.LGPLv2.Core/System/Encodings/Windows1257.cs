...
{
    public class Windows1257EncodingProvider : EncodingProvider
    {
        public override Encoding GetEncoding(int codepage)
        {
            return codepage == 1257 ? new Windows1257() : null;
        }

        public override Encoding GetEncoding(string name)
        {
            return name.Equals("windows-1257", StringComparison.OrdinalIgnoreCase) ? new Windows1257() : null;
        }
    }
