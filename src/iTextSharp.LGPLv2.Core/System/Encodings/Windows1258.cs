...
{
    public class Windows1258EncodingProvider : EncodingProvider
    {
        public override Encoding GetEncoding(int codepage)
        {
            return codepage == 1258 ? new Windows1258() : null;
        }

        public override Encoding GetEncoding(string name)
        {
            return name.Equals("windows-1258", StringComparison.OrdinalIgnoreCase) ? new Windows1258() : null;
        }
    }
