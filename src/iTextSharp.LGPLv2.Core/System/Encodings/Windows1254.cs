...
{
    public class Windows1254EncodingProvider : EncodingProvider
    {
        public override Encoding GetEncoding(int codepage)
        {
            return codepage == 1254 ? new Windows1254() : null;
        }

        public override Encoding GetEncoding(string name)
        {
            return name.Equals("windows-1254", StringComparison.OrdinalIgnoreCase) ? new Windows1254() : null;
        }
    }
