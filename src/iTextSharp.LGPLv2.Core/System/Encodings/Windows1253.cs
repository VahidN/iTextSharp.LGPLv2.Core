...
{
    public class Windows1253EncodingProvider : EncodingProvider
    {
        public override Encoding GetEncoding(int codepage)
        {
            return codepage == 1253 ? new Windows1253() : null;
        }

        public override Encoding GetEncoding(string name)
        {
            return name.Equals("windows-1253", StringComparison.OrdinalIgnoreCase) ? new Windows1253() : null;
        }
    }
